...
# testing_set['upvotes'] = df_test['upvotes']
# testing_set['answers'] = df_test['answers']
# testing_set['top_quality_ans'] = df_test['top_quality_ans']
...
prob = result.predict_proba(test_set)
